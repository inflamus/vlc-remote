...
// @output_file_name ratchet.custom.min.js
// ==/ClosureCompiler==
...
!(function () {
  ...
  var handleModal = function (event) {
    ...
    if (modal) {
      ...
      history.replaceState({modal:modal.id}, '');
    }
  };
...
//   window.document.addEventListener('DOMContentLoaded', loadHistory);
//   window.addEventListener('popstate', preventClosing);
  window.addEventListener('touchend', handleModal);
