 ...
 * =====================================================
 */
!function(){var f=function(d){var a;b:{a=d.target;for(var b,l=document.querySelectorAll("a");a&&a!==document;a=a.parentNode)for(b=l.length;b--;)if(l[b]===a)break b;a=void 0}a=a&&a.hash?document.querySelector(a.hash):void 0;a&&(a&&a.classList.contains("modal")&&a.classList.toggle("active"),d.preventDefault())};window.addEventListener("touchend",f);window.addEventListener("click",f)}();
